...
% 2) performs a set of shuffling (defined by a set of shuffling lengths) and completes the same return time histogram analysis for each shuffling length
...
for i=1:tree_l
    ...
    locss=locs;
    locss(1:end-1)=locss(2:end); % shifted version of locations of i
    
    locsd=locss(1:end-1)-locs(1:end-1); % lag between two consecutive appeareances of i
    edges=1:maxh;
