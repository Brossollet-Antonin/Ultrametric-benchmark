...
date="2019-07-15"
T = '0.150'
learningrate = ['0.0010', '0.0100', '0.0500']
...
for lr in learningrate:
    ...
    path = "C:/Users/Antonin/Documents/Documents/ENS 2A/Stage M1/Results/LR/"+dataset+"/"+date+"/T" + T + '/LR'+lr
...
palette = sns.color_palette("GnBu_d", len(learningrate))


fig, ax = plt.subplots(figsize=(9,9))

final_plot = sns.lineplot(x="nbr_ex", y='acc', data=totaldata, ci=None, 
                         hue="LR", style="Mode", palette=palette)
...
original_seq5 = pkl.load(open("C:/Users/Antonin/Documents/Documents/ENS 2A/Stage M1/Results/LR/"+dataset+"/"+date+"/T" + '0.150' + '/LR'+'0.1000'+'/3/original', 'rb'))
shuffle_seq5 = pkl.load(open("C:/Users/Antonin/Documents/Documents/ENS 2A/Stage M1/Results/LR/"+dataset+"/"+date+"/T" + '0.150' + '/LR'+'0.1000'+'/3/shuffle', 'rb'))
#
