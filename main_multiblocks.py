...
from data_saver import save_results_multiblocks
	...
	for batch_sz in args.minibatches_list:
		for memory_sz in args.memory_list:
			for T in args.temperature_list:
				...
				rs = ultrametric_analysis_across_blocksizes(trainer, args, args.block_size_shuffle_list)
				...
				save_results_multiblocks(rs, save_root)
